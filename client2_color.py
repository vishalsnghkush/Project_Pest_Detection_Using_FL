...
#                 CONFIGURATION
# ----------------------------------------------------
SERVER_URL = "http://192.168.1.9:5000/"   # ✅ no slash at end
CLIENT_ID = "client_2"
DATASET_TYPE = "color"   # choose: "color", "grayscale", "segmented"
LOCAL_DATA_DIR = r"C:\Users\VISHAL KUSHWAHA\OneDrive\Desktop\Federated_Learning\plantvillage dataset\color"
